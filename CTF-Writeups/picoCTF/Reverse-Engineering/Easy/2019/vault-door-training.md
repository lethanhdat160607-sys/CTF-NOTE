...
This challenge is simply using the `nano` command to examine the code, as the flag is already inside; it's a basic exercise to help us identify the flag, This is the flag `password.equals("w4rm1ng_Up_w1tH_jAv4_000uMfhzBuS");`.
...
## Run 
.flag picoCTF{w4rm1ng_Up_w1tH_jAv4_000uMfhzBuS}
